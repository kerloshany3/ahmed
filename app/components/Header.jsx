    ...
    return (
        <div className=' flex justify-between'>
            ...
            <div className=' place-items-center gap-4 flex'>
                ...
                <div className=' flex'>
                    <div className='  place-items-center  bg-red-500 text-3xl flex p-4 h-16 rounded-xl text-white font-arabicUI shadow-xl shadow-red-600/40 outline-dashed outline-red-500 outline-offset-4'>
                    ...
                    <div className=' place-items-center ml-5  bg-blue-500 text-white h-16 text-3xl p-4 rounded-xl  font-arabicUI shadow-xl shadow-blue-600/40 outline-dashed outline-blue-400  outline-offset-4 flex' >
            ...
            <div className=' flex place-items-center  dark:text-slate-400 text-4xl border-4 dark:border-slate-400 border-slate-800  p-3 pb-6 rounded-t-2xl  rounded-l-2xl shadow-2xl shadow-slate-500/50'>

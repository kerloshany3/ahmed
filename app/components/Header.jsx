...
const Header = () => {
    return (
        <div className=' max-sm:scale-90 flex justify-between'>
            ...
            <div className=' max-md:hidden flex place-items-center  dark:text-slate-400 text-4xl border-4 dark:border-slate-400 border-slate-800  p-3 pb-6 rounded-t-2xl  rounded-l-2xl shadow-2xl shadow-slate-500/50'>
